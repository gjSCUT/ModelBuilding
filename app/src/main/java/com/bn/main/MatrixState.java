...
任����
    ...
    [16];//4x4���� ͶӰ��
	public static float[] mMVPMatrix=new float[1��λ��;//���������任������˵�ģ�;���
	public static float[] mRotaλ�Matrix=new float[16];//��ת����
	public static float[] mTranatateMatrix=new float[16];//��������
	public static float6]caleMatrix=new float[16];//ƽ�ƾ���
 te static FloatBuffer cameraFB;
    publslFloatBuffer lightPositionFB;

    //�����任�����ջ
    s[] mS float[][] mStack=new f   publicx, 0, currMatrix, 0);
		//Matrix.scaleM(currMatrix, 0, x, y, z);
	}ic static   //���������
    static ByteBuffer llbb= ByteBufftaticetViewProjMatrix()
    {
    	float[] mViewMatrix=new float[16];
    	Matloat[100][    private static float[] currMatrix;//��   	Matrix�Դλ��
    private static float[] mVMatrix = new float[16];//�����ack[stackTó���9��������
	private static float[] mProjMatrix = new flo[i]=mStack
16];
...
[stackTop][i];
    ...
    public static void translate(float x,float y,float z)
    {
    	...
    	Matrix.multiplyMM(currMatrix, 0, tempMatrix, 0, currMatrix, mpMatri
/Matrix.translateM(currMatrix, 0, x, y, z);
    ...
    public static void rotate(float x,float y,float z, float angle)
    {
    	...
    	Matrix.multiplyMM(currMatrix, 0, currMatrix, 0, q.getRotateMatrix
	...
	{
		//mRotateMatrix=nMatrix;er.al
ix.multiplyMM(currMatrix, 0, tempMatrix, 0, currMatrix, 0);
	}
	...
	public static void scale(float x, float y, float z) {
    	...
    	Matrix.multiplyMM(currMatrix, 0, te       cam
locateDirect(3*4);
...
/near�����
    ...
    {
    	Matrix.multiplyMM(mM);
0, mVMatrix, 0, currMatrix, 0);
        Matrix.multiplyMM(mMVPMatrix, 0, mProjMatrix, 0, mMVPMatrix, 0SMatrix()
    ...
    //��ȡ���������ƽ�Ʒ�������
    public static float[] getTtatic floa
    {
        return currMatrix;
    }
...
c static float[] getRotateMatrix()
    {
   ...
   public static float[] getProjMatrix()
    ...
    public staticrix.m
ultiplyMM(mViewMatrix, 0, mProjMatrix, 0, mVMatrix, 0);
        return mViewMatrix;
    }
