    ...
    public boolean splitFaces(Object3D object) {
        ...
        if (getBound().overlap(object.getBound())) {
            ...
            for (int i = 0; i < getNumFaces(); i++) {
                ...
                if (face1.getBound().overlap(object.getBound()))//���Ը����Ƿ�����һ�������ཻ
                {
                    for (int j = 0; j < object.getNumFaces(); j++)//����һ�����ÿһ����
                    {
                        face2 = object.getFace(j);
                        Face face2Orig = new Face();
                        face2Orig.setFace(face2);

                        if (face1.getBound().overlap(face2.getBound()))//���Ը�������һ����������Ƿ��ཻ
                        {
                            //�������ÿһ�㵽��һ�������ľ���
                            ...
                            if ((signFace1Vert1 == signFace1Vert2 && signFace1Vert2 == signFace1Vert3) == false)//���3�����벻����ȫ��ȵ�
                            {
                                //������һ��ÿһ�㵽���������ľ���
                                ...
                                if ((signFace2Vert1 == signFace2Vert2 && signFace2Vert2 == signFace2Vert3) == false)//���3�����벻����ȫ��ȵ�
                                {
                                    //������Ľ���
                                    ...
                                    if (segment1.intersect(segment2) == true)//��������±��ཻ
                                    {
                                        ...
                                        if (face1.match(face1Orig) == false)//���face1�仯
                                        {

                                            if (face1Orig.equals(getFace(getNumFaces() - 1)) == true)//���face1�Ǹ������һ����
                                            {
                                                if (i != (getNumFaces() - 1))//���i�������һ����
                                                {

                                                    faces.remove(getNumFaces() - 1);//ɾ�����һ����
                                                    faces.add(i, face1Orig);//��ԭʼ����ӵ�����
                                                } else {
                                                    continue;
                                                }
                                            } else//i���ˣ����¿�ʼѭ��
